...
class LifeBar extends PositionComponent {
  ...
  void incrementCurrentLifeBy(int incrementValue) => currentLife = _life + incrementValue;
  ...
  void decrementCurrentLifeBy(int decrementValue) => currentLife = _life - decrementValue;
  ...
  Vector2 _calculateBarPosition() {
    return switch (_placement) {
      (LifeBarPlacement.left) => Vector2(0, -_size.y - _barToParentOffset),
      (LifeBarPlacement.center) => Vector2((_parentSize.x - _size.x) /2, -_size.y - _barToParentOffset),
      (LifeBarPlacement.right) => Vector2(_parentSize.x - _size.x, -_size.y - _barToParentOffset),
    };
  }

  @override FutureOr<void> onLoad() {
