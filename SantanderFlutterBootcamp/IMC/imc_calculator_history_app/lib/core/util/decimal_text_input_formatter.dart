...
class DecimalTextInputFormatter extends TextInputFormatter {
  ...
  static FilteringTextInputFormatter get signal => Platform.localeName == 'pt_BR' ? FilteringTextInputFormatter.allow(RegExp("[0-9,]")) : FilteringTextInputFormatter.allow(RegExp("[0-9.]"));
